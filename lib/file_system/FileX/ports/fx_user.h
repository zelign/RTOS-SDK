...
#define FX_BOOT_RECORD_LOGIC_SECTOR     0    /* Offset of the logical sector number in the boot record.  */
#define FX_LOGICAL_SECTOR_SIZE          512      /* Minimum value is 512, all other values must be a power of 2.  */
