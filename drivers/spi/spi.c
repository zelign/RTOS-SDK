 ...
 * 
 */
static inline void trans_direct(enum spi_dev sd, enum trans_direct_type tdt,
				enum rev_mode rm)
{
	if (tdt) {
...
static inline void data_frame_format(enum spi_dev sd,
				     enum data_frame_format_e dff)
{
...
static inline void
software_slave_management(enum spi_dev sd, enum software_slave_management_e ssm)
{
...
static inline void baud_rate_control(enum spi_dev sd,
				     enum baud_rate_control_e brc)
{
...
static inline void clock_polarity_phase(enum spi_dev sd,
					enum clock_polarity_phase_e cpp)
{
